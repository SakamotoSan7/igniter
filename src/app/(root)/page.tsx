	...
	return (
		<>
			...
			<section className="section_container">
				...
				<ul className="mt-7 card_grid">{posts?.length > 0 ? posts.map((post: StartupCardType) => <StartupCard key={post?.id} post={post} />) : <p className="no-results">No Startups Found</p>}</ul>
			</section>
		</>
	);
}
